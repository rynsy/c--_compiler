...
#
# DESCRIPTION
# This script should be in the directory where cmm2pstack or cmm2pstack
# is located.
...
execute () {
  ...
  if [ -x ./cmm2pstack ] && [ -x ./pstack/api ]; then
    ./cmm2pstack  "$testfile" calc_out.apm  >&2 &&
    ./pstack/api calc_out
